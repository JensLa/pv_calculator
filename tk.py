...
############# Calculate #############
def calculate():
    global result_power, result_max_leerlaufspannung, result_vmpp_min, result_vmpp_max, result_impp_max, result_entries, calculate_entries
